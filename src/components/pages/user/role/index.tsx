...
const RolePermissionLayout = () => {
	...
	return (
		<section>
			...
			{tabsVal === 0 && <AccessSettingLayout type="client" value={tabsVal} />}
			{tabsVal === 1 && <RoleListLayout type="client" value={tabsVal} />}
			{tabsVal === 2 && <PermissionLayout type="client" value={tabsVal} />}
		</section>
	);
};
